...
\Plainauthor{Paul Deveau, Emmanuel Barillot, Andrei Zinovyev, Eric Bonnet} %% comma-separated
...
a global map, five individual maps, and a total of 55 functional modules, as of today. Each
...
represent_enrichment(enrichment = list(Corrected = results[1:10,], 
...
functional modules of the Atlas of Cancer Signaling Networks (ACSN) . Enrichment can be
...
complementary to \pkg{ACSNMineR}. This package is dedicated to create web-based
