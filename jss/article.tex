...
(extra cellular matrix) are the modules with highest significance (corrected
p-values of 2.55e-11 and 2.34e-9 respectively). Visualization of the list of
frequently mutated genes is shown on figure \ref{fig:gbm}. This figure was
generated with the ACSNMineR commands detailed below. 
