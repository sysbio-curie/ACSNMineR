...
\code{genes_test} it is possible to explore the different possibilities of
exploration of the maps. We previously computed the p-value of
\code{genes_test} with default parameters.  The number of modules which have a
p-value below 0.05 was 36, that can be compared to the 49 obtained without
correction: \code{enrichment(genes_test,correction_multitest = FALSE)}
...
Apoptosis:WNT CANONICAL & 53 & E2F1 EP300 KAT2B  & 4.984433e-03 & greater \\
	\hline
=======
>>>>>>> bf254f9f67f8ede498abde8c02972d99456a2bc2
	\end{tabular}
\end{table}
