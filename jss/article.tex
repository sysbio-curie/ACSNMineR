...
Currently, ACSN maps covers signaling pathways involved in DNA repair, cell cycle,
cell survival, cell death, epithelial-to-mesenchymal transition (EMT) and cell
motility. The information included in ACSN is organized in three hierarchical
levels: a global map, which is composed of five individual maps, themselves
composed of many functional modules covering individual pathways. Each map in
ACSN covers hundreds of molecular players, biochemical reactions and causal
...
involving 2,371 proteins, and is continuously updated and expanded. 
We have included the three hierarchical levels in the \pkg{ACSNMineR} package,
in order to be able to calculate enrichments at all three levels. 
