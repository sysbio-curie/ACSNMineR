...
cycle, cell survival, cell death, epithelial-to-mesenchymal transition (EMT)
and cell motility. The information included in ACSN is organized in three
hierarchical levels: a global map, which is composed of five individual maps,
themselves composed of many functional modules covering individual pathways.
Each map in ACSN covers hundreds of molecular players, biochemical reactions
and causal relationships between the molecular players and cellular phenotypes.
ACSN represents a large-scale biochemical reaction network of 4,826 reactions
...
to be able to calculate enrichments at all three levels. 
